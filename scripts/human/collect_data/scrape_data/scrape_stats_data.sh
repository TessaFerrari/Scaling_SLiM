...
for file in slurm_logs/human/stats/*
do
	...
	awk '$2 ~ /\*\*\*\*\*\*\*\*\*\*/ {print $0}' $file | cut -d\  -f3- > out/human/burn${t}_scale${c}_gensize${G}/humanBench_${x}_c${c}_${G}_h${h}_n${n}_rep${rep}.stats.txt # print data to file
