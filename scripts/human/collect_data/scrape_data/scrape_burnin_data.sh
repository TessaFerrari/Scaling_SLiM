...
for file in slurm_logs/human/burnIn/*
do
	...
	awk '$2 ~ /\*\*\*\*\*\*\*\*\*\*/ {print $0}' $file | cut -d\  -f3- > out/human/burn${t}_scale${c}_gensize${G}/humanBench_burnin${n}_${x}_c${c}_${G}.txt # print data to file

	# Append coalescence info to file
	awk '/COALESCE/ {print $0}' $file >> out/human/burn${t}_scale${c}_gensize${G}/humanBench_burnin${n}_${x}_c${c}_${G}.txt
