...
# Make burn-in script
cat > ./scripts/temp/humanBench_stats_${t}Ne_c${c}_${G}_h${h}_n${n}_rep${rep}.job << EOM
...
1 late() { 
	...
	sim.readFromPopulationFile("/scratch1/tferrari/SlimBenchmark/human/out/burn${t}_scale${c}_gensize${G}/humanBench_${t}Ne_c${c}_${G}_h${h}_n${n}_rep${rep}.trees");
	
	// Output VCFs
	p1_ids = p1.individuals.genomes;
        p1_ids.outputVCF(filePath="/scratch1/tferrari/SlimBenchmark/human/out/burn${t}_scale${c}_gensize${G}/humanBench_${t}Ne_c${c}_${G}_h${h}_n${n}_rep${rep}.african.vcf");	
	p2_ids = p2.individuals.genomes;
        p2_ids.outputVCF(filePath="/scratch1/tferrari/SlimBenchmark/human/out/burn${t}_scale${c}_gensize${G}/humanBench_${t}Ne_c${c}_${G}_h${h}_n${n}_rep${rep}.european.vcf");
	p3_ids = p3.individuals.genomes;
        p3_ids.outputVCF(filePath="/scratch1/tferrari/SlimBenchmark/human/out/burn${t}_scale${c}_gensize${G}/humanBench_${t}Ne_c${c}_${G}_h${h}_n${n}_rep${rep}.eastasian.vcf");
