...
for file in slurm_logs/fly/main/*
do
	...
	awk '$2 ~ /\*\*\*\*\*\*\*\*\*\*/ {print $0}' $file | cut -d\  -f3- > out/fly/burn${t}_scale${c}_gensize${G}/flyBench_${x}_c${c}_${G}_h${h}_n${n}_rep${rep}.txt # print data to file
