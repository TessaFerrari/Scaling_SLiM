...
burn_coal_data <- as.data.frame(fread("fly_burn_coalescence_stats.txt", sep="\t"))
burn_coal_data$BurnInType <- factor(as.character(burn_coal_data$BurnInType), levels = c("5","10","20"))
burn_coal_data$ScalingFactor <- factor(as.character(burn_coal_data$ScalingFactor), levels = c("100","500","1000"))
...
main_coal_data$ScalingFactor <- factor(as.character(main_coal_data$ScalingFactor), levels = c("100","500","1000"))
...
popsfsData$ScalingFactor <- factor(as.character(popsfsData$ScalingFactor), levels = c("100","500","1000"))
...
ldData$ScalingFactor <- factor(as.character(ldData$ScalingFactor), levels = c("100","500","1000"))
...
ggsave(logplot, filename = "C:/Users/tferrari/Desktop/SlimBenchmark/figures/Round2_GBE_Revisions/fly_burnin_coaleventsVSbranchlen_log10axes.pdf",
       device = cairo_pdf, width = 11, height = 8.5, units = "in")
ggsave(regplot, filename = "C:/Users/tferrari/Desktop/SlimBenchmark/figures/Round2_GBE_Revisions/fly_burnin_coaleventsVSbranchlen_linreg.pdf", 
       device = cairo_pdf, width = 11, height = 8.5, units = "in")

# Save coal vs summary stats
ggsave(coalVShet_afr, 
       filename = "C:/Users/tferrari/Desktop/SlimBenchmark/figures/GBE_Revisions_2/1_raw_figures/coalescence_events_vs/fly_coalVShet.pdf", 
       device = cairo_pdf, width = 5, height = 4.25, units = "in")
ggsave(coalVStheta_afr, 
       filename = "C:/Users/tferrari/Desktop/SlimBenchmark/figures/GBE_Revisions_2/1_raw_figures/coalescence_events_vs/fly_coalVStheta.pdf", 
       device = cairo_pdf, width = 5, height = 4.25, units = "in")
ggsave(coalVSld_afr, 
       filename = "C:/Users/tferrari/Desktop/SlimBenchmark/figures/GBE_Revisions_2/1_raw_figures/coalescence_events_vs/fly_coalVSld.pdf", 
       device = cairo_pdf, width = 5, height = 4.25, units = "in")
